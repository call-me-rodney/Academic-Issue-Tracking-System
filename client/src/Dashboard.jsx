  ...
  return (
    <div>
      <div className="sidebar">
        ...
        <ul>
          <li>
            <LucideGraduationCap className="search-icon" />
            <i />
            Course
          </li>
          <li>
            <LucideBookUser className="search-icon" />
            <i />
            My Result
          </li>
          <li>
            <LucideContact className="search-icon" />
            <i />
            My Issues
          </li>
          <li>
            <LucideCalendar className="search-icon" />
            <i />
            Academic Calender
          </li>
          <li>
            <LucideFolderHeart className="search-icon" />
            <i />
            My Profile
          </li>
          <li></li>
